...
machine="h200"
DEFAULT_ANNS_JSON = "data/objverse_minghao_4d_mine_40075/rendering_v5_anns_1.3k.json"
...
def load_object_dirs_from_anns(
    ...
    if machine == "h200":
        uniq_new = []
        for x in uniq:
            x = str(x).replace("/group/40075/yanruibin/objverse_minghao_4d_mine/rendering_v5", DEFAULT_DATASET_ROOT)
...
"""
python tools/from_mesh_to_training_data/v2_mp_h200.py \
  --splits train test \
