...
python tools/submit_extract_mesh_camera_sparse_voxel_cuda_v2.py \
    ...
    --worker_script tools/extract_mesh_camera_sparse_voxel_v4_interleave_light_optimized_128frame_mp4_no_perframe_center.py \
    ...
    --sunlight_prob 0.5 \
    --extra_worker_args --cycles_backend CUDA --cycles_use_denoising